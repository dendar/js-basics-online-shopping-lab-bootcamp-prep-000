...
function viewCart() {
  ...
  if(cart.length===0){
    ...
    var printTwoItems=`In your cart, you have ${Object.keys(cart[cart.length-2])} at $${cart[cart.length-2][Object.keys(cart[cart.length-2])]} and ${Object.keys(cart[card.length-1])} at $${cart[cart.length-1][Object.keys(cart[cart.length-1])]}.`
